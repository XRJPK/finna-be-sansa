...
$Group1 = GUICtrlCreateGroup("Summary Information", 328, 8, 257, 361)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$Button1 = GUICtrlCreateButton("MSI öffnen ", 24, 32, 75, 25)
$Button2 = GUICtrlCreateButton("MSI schreiben", 24,60, 80, 25)
$Button3 = GUICtrlCreateButton("Reverse GUID", 24,94, 80, 25)
$Title = GUICtrlCreateLabel("Title", 344, 32, 24, 17)
$Author = GUICtrlCreateLabel("Author", 344, 64, 35, 17)
$Plattform = GUICtrlCreateLabel("Plattform", 344, 88, 45, 17)
$Langauges = GUICtrlCreateLabel("Langauges", 344, 120, 57, 17)
$Package_Code = GUICtrlCreateLabel("Package Code", 344, 144, 75, 17)
$Schema = GUICtrlCreateLabel("Schema", 344, 168, 43, 17)
$Input1 = GUICtrlCreateInput("", 450, 40, 130, 21)
GUICtrlSetState(-1, $GUI_DISABLE)
$Input2 = GUICtrlCreateInput("", 450, 64, 130, 21)
GUICtrlSetState(-1, $GUI_DISABLE)
$Input3 = GUICtrlCreateInput("", 450, 88, 130, 21)
GUICtrlSetState(-1, $GUI_DISABLE)
$Input4 = GUICtrlCreateInput("", 450, 112, 130, 21)
GUICtrlSetState(-1, $GUI_DISABLE)
$Input5 = GUICtrlCreateInput("", 450, 136, 130, 21)
$Input6 = GUICtrlCreateInput("", 450, 160, 130, 21)
...
While 1
	...
	Case $Button1 ; MSI öffnen
			...
			;MsgBox(0, "Debug", "Das Verzechnis ist: "  & $verzeichnis, 10)
